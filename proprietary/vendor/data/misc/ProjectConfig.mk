...
CUSTOM_HAL_IMGSENSOR = gc2385_mipi_raw gc030A_mipi_raw
...
#add by wangpeng for no light sensor begin
#CUSTOM_KERNEL_ALSPS = yes
CUSTOM_KERNEL_PS = yes
#add by wangpeng for no light sensor end
...
CUSTOM_KERNEL_IMGSENSOR = gc2385_mipi_raw gc030A_mipi_raw
...
CUSTOM_MODEM = BD6580_3SIM_HSPA_7130DW_B1B8_V187	               	
...
#MTK_WMA_PLAYBACK_SUPPORT = yes to no wanpeng
...
BIRD_PTP_MTP_MODEL=LINX_ALFA_3G
#BIRD_CUSTOM_BROWSER_CONFIG = 5013_Q
BIRD_BUILD_PRODUCT = LT4047MG
BIRD_PRODUCT_NAME=LINX_ALFA_3G
BIRD_PRODUCT_BRAND=DIGMA
BIRD_PRODUCT_BOARD=LT4047MG
BIRD_PRODUCT_MODEL=LINX ALFA 3G LT4047MG
BIRD_PRODUCT_DEVICE=LT4047MG
BIRD_PRODUCT_MANUFACTURER=DIGMA
BIRD_BT_STRING = LINX_ALFA_3G 
BIRD_WLAN_DIRECT_NAME = LINX_ALFA_3G
BIRD_WLAN_SSID_STRING = LINX_ALFA_3G
BIRD_USB_DRIVER_STRING= LINX_ALFA_3G
BIRD_MTP_MANUFACTURER = LINX_ALFA_3G
BIRD_MTP_MODEL = LINX_ALFA_3G
BIRD_MTP_LABEL = LINX_ALFA_3G
BIRD_PTP_MODEL = LINX_ALFA_3G
BIRD_NET_HOSTNAME= LINX_ALFA_3G
#BIRD_TORCH=yes
BIRD_CUSTOM = 7130D_S8022A_E_DS442_DIGMA
BIRD_MEMORYDEVICELIST_DS = yes
BIRD_DEFAULT_WALLPAPER = DIGMA_DEFAULT_WALLPAPER
BIRD_CUSTOM_DIGMA_KEY=yes
BIRD_FIRST_LOGO = DIGMA_WVGA_LOGO
BIRD_SECOND_LOGO = DIGMA_WVGA_LOGO
BIRD_MAIN_IMGSENSOR = gc2385_mipi_raw_7130D_S8022B_AM_DS842
BIRD_SUB_IMGSENSOR = gc030A_mipi_raw_7130D_S8022B_AM_DS842
BIRD_WRITE_IMEI = yes
BIRD_MMI_AUTO_TEST = yes
#BIRD_MMI_AUTO_TEST_OTG = yes
...
#BIRD_MMI_AUTO_TEST_HALL = yes
#BIRD_MMI_AUTO_TEST_NFC = yes
...
#BIRD_MMI_AUTO_TEST_TIPLAMP = yes
...
BIRD_MMITEST_FOOLPROOF= yes
#BIRD_MMI_TEST_KEYBOARD_SAMSUNG = yes
BIRD_BOOT_ANIMATION=DIGMA_WVGA_ANI
#每个版本变化
BIRD_BUILD_DISPLAY_ID = Digma_LINX_ALFA_3G_V1.1_$(shell date +%Y%m%d)
BIRD_BUILD_NUMBER = Digma_LINX_ALFA_3G_V1.1_$(shell date +%Y%m%d)
BIRD_EM_VERNO = Digma_LINX_ALFA_3G_V1.1_$(shell date +%Y%m%d)
BIRD_INNER_SW_VERSION = 7130D_S8022A_E.A1.$(shell date +%Y%m%d).AD80.V21.WVGA.DS44.B18.MP.RU
BIRD_DEFAULT_PICTURE_RATIO_BACK = 4:3
BIRD_DEFAULT_PICTURE_RATIO_FRONT = 4:3
BIRD_DEFAULT_FONT_SIZE=2
BIRD_DEFAULT_DISPLAY_SIZE=yes
BIRD_DEFAULT_MEDIA_SOUND=7
GOOGLE_GMS8.1R1.06=yes
BIRD_COMPATIBLE_MARK_CHECK_APK=yes
BIRD_COMPATIBLE_MARK=A1
BIRD_CONFIG_CODE=287884494
#BIRD_KERNEL_VERSION=3.18
#ADUPS_FOTA_SUPPORT=yes
#ADUPS_FOTA_WITH_ICON=no
#ADUPS_FOTA_WITHOUT_MENU=no
BIRD_CHANGE_XICON_OFF=yes
BIRD_REMOVER_SYSTEM_UPDATE=yes
BIRD_CUSTOM_VERSION_OFF=yes
BUILD_GMS = yes 
BIRD_MEDIAKEY_TYPE=yes
BIRD_HIDE_SIMCARD_PREF=yes
BIRD_DEFAULT_SERIALNUMBER=yes
#BIRD_FAKE_FOCUS=yes
BIRD_DEFAULT_DATE_FORMAT=2
BIRD_SHOW_UNREADNUM_IN_LAUNCHER=yes
BIRD_FM_DEFAULT_STATION=1043
BIRD_DEFAULT_GB=yes
BIRD_DEFAULT_SERIALNUMBER=yes
BIRD_FAKE_LEISA_ROM=4096 
BIRD_KEYGUARD_AMPM_LEFT_DATE=yes
BIRD_ADD_AM_PM_STYLE=yes
BIRD_PARA_INFO_CONFIG=7130D_S8020D_T_DS442
BIRD_DIGMA_APK=yes
BIRD_CUSTOM_APN=digma
BIRD_DEFAULT_TIMEZONE=Europe/Moscow
BIRD_SHOW_BATTERY_PERECNT=yes
BIRD_NETWORK_3G_AUTO=yes
BIRD_REMOVE_PHYSICAL_KEYBOARD=yes
BIRD_SLIENT_REMOVE_VIBRATOR=yes
BIRD_WIFI_SCAN_INTERVAL_TIME = 120
BIRD_DEFAULT_TIME_12_24=24
